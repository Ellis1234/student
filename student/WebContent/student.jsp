...
<script type="text/javascript" src="/student/js/jquery.easyui-lang-zh_CN.js">
</script>
...
<body>
<s:form method="post" action="student" theme="simple">
...
<s:if test="#role==2">    
  ...
  <s:textfield name="type"/>
    入学日期：
  <s:textfield name="date" class="easyui-datebox" editable="false"/><br>
    籍贯:
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#C0C0C0" width="1500">
  <tr>
    <td width="100%" bgcolor="#C0C0C0" align="center" colspan="16">
